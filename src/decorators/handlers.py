...
class ClassDecorator:
    def __init__(self, main_function: Callable):
        self.main_function = main_function
    
    def __get__(self, instance: T, instance_class: Type[T]) -> Callable:
        #* The `self(...)` statement, executes the `__call__` dunder method.
        return lambda *args, **kwargs: self(instance, *args, **kwargs)
    ...
    # def __call__(main_function, *arguments, *kw_arguments):
...
class ClassToDecorate:
    class_type: str = "class_to_decorate"
    
    @ClassDecorator
    def foo(self, a, b):
        print("Inside the method to decorate")
        print(a + b)
    
    @ClassDecorator
    def another_foo(self, a, b):
        print("Inside the another_foo method")
        print(a * b)
